...
naughty.config.defaults.font = beautiful.font or "terminus 5"
naughty.config.defaults.icon = nil
naughty.config.defaults.icon_size = 256
naughty.config.defaults.fg = beautiful.fg_tooltip or "#ffffff"
naughty.config.defaults.bg = beautiful.bg_tooltip or "#000000"
